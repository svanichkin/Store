#
#  Be sure to run `pod spec lint Store.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/svanichkin/Store"
  ...
  spec.source       = { :git => "https://github.com/svanichkin/Store.git", :tag => "#{spec.version}" }
  ...
  spec.framework  = "Foundation", "StoreKit"
